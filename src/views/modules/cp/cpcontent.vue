      ...
      <el-form :rules="dataRule" :model="dataFormw" ref="dataForm" @keyup.enter.native="dataFormSubmit()">
        <div class="shadow">
          <el-form-item label="" prop="">
            <el-row :gutter="20" v-for="(ditem,dindex) in dataFormw.dataForm" :key="ditem.dindex" style="border-bottom:1px solid rgba(0, 0, 0, 0.1);position: relative;">
              <el-col :span="16">
                <div class="br1 pd32">
                  ...
                  <el-form-item label="" prop="">
                    <div v-for="(item, index) in ditem.cpresult" :key="item.index">
                      ...
                      <div v-for="(itemm, indexx) in item.project" :key="itemm.indexx">
