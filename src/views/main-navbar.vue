<template>
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header" v-if="!sidebarFold">
      <h1 class="site-navbar__brand" @click="clickPush()">
        <a class="site-navbar__brand-lg" href="javascript:;">测评系统</a>
      </h1>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      clickPush () {
        this.$router.push({path: sessionStorage.getItem('homeUrl')}) // 强制切换当前路由path
      },
      // 修改密码
